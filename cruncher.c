...
int main(int argc, char *argv[]) {
	...
	person_map   = (Person *)         mmapr(makepath(argv[1], "person_new",   "bin"), &person_length);
	interest_map = (unsigned short *) mmapr(makepath(argv[1], "interest_new", "bin"), &interest_length);
